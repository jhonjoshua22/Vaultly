...
const inputStyle = { flex: 1, background: 'transparent', border: 'none', color: '#fff', fontSize: '1rem', outline: 'none', textAlign: 'left', padding: '0', WebkitAppearance: 'none', appearance: 'none', };
